...
class controller:
    def __init__(self,meta_program_graph):
        ...
        self.system_prompt += 'If you have collected enough information in current meta program graph to answer user\'s question, and consider there\'s no need to make further calls, you should only output a json with the following format: {"method": "None","args": []}, with no other extra word at all.'
