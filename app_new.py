...
class controller:
    def __init__(self,meta_program_graph,executed_methods):
        ...
        self.system_prompt += "Try your best stop as soon as possible, if you find enough information."
...
def get_answer(prompt,meta_program_graph,program_controller,output_formatter,output_typer,search_string_generator,adma_recommender,max_iter=10):
    ...
    while max_iter > 0:
        ...
        if next_task["method"] == "None":
            ...
            print(f"ADMA_search_string: {meta_program_graph['ADMA_search_string']['value']}")
