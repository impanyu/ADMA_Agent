...
class meta_program_graph_initializer:
    def __init__(self,meta_program_graph):
        ...
        self.system_prompt += "If the user's instruction contains related information, you can set the value based on the information. Otherwise, just set it to current value of the variable in the meta program graph."
