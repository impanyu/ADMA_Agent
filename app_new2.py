...
class meta_program_graph_initializer:
    def __init__(self,meta_program_graph):
        ...
        self.system_prompt += "Note: If the user's instruction contains related information, you can return the value of the variable based on the information. Otherwise, just return the value of the variable 'NA'."
